...
if __name__ == "__main__":
    model = YOLO(r"C:\Users\ZJZ0\Desktop\python深度学习\ultralytics\runs\classify\train4\weights/best.pt")  # load a custom model
    results = model.predict(r"C:\Users\ZJZ0\Desktop\python深度学习\datasets/2.png")  # predict on an image
